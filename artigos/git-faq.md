...
apenas faz sentido em cenários bem específicos. Apesar disso, ela
...
> A área de stag constitui um fardo desnecessário e uma carga 
...
Por exemplo, suponha que realizou uma mudança no código que já atende a seus
...
melhor e, portanto, conclui realizando um novo `git add`, seguido de um 
`git commit`. 
...
não deram certo e que estão no diretório de trabalho.
