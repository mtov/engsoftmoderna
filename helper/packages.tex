...
\geometry{papersize={17cm,24cm},bottom=3pc,top=5pc,inner=2.54cm,outer=1.8cm,bmargin=4.5pc,footskip=18pt,headsep=25pt}
...
\renewenvironment{quote}{\centering \vspace{1.5ex} \begin{tcolorbox}[colback=green!7!white, width=4.9in]}{\end{tcolorbox}}
...
\newenvironment{aviso}{\centering \vspace{1.5ex} \begin{tcolorbox}[breakable, colback=yellow!10!white, , width=4.9in]}{\end{tcolorbox} \vspace{1.5ex}}
