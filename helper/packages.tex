...
%\geometry{papersize={17cm,24cm},bottom=4pc,top=6pc,left=2.15cm,right=2.15cm,bmargin=4.5pc,footskip=18pt,headsep=25pt}
...
\renewenvironment{quote}{\centering \vspace{1.5ex} \begin{tcolorbox}[colback=green!7!white, width=4.8in]}{\end{tcolorbox}}

\newenvironment{esmbox}{\centering \vspace{1.5ex} \begin{tcolorbox}[breakable, colback=backcolor, width=4.8in]}{\end{tcolorbox} \vspace{1.5ex}}

\newenvironment{aviso}{\centering \vspace{1.5ex} \begin{tcolorbox}[breakable, colback=yellow!10!white, , width=4.8in]}{\end{tcolorbox} \vspace{1.5ex}}
